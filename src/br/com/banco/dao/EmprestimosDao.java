...
public class EmprestimosDao {
	...
	public void cadastrarEmprestimos(EmprestimosBean eb) {
		...
		// Comando SQL
		String sql = "INSERT INTO emprestimos (idConta, valorInicial, valorProximaParcela, dataProximaParcela, parcelasRestantes) VALUES (?, ?, ?, ?, ?)";
	...
	public DefaultTableModel listarAgencias() {
		...
		try {
			...
			while (rs.next()) {
				...
				modelo.addRow(new Object[] { rs.getInt("id"), rs.getInt("idConta"), rs.getInt("valorInicial"),
						rs.getInt("valorProximaParcela"), rs.getInt("dataProximaParcela"),
						rs.getInt("parcelasRestantes") });
			}
	...
	public EmprestimosBean obterInformacoesDoId(int idEmprestimo) {
		...
		try {
			...
			while (rs.next()) {
				eb.setDataProximaParcela(rs.getString("dataProximaParcela"));
				eb.setIdConta(rs.getInt("idConta"));
				eb.setParcelasRestantes(rs.getInt("parcelasRestantes"));
				eb.setValorInicial(rs.getDouble("valorInicial"));
				eb.setValorProximaParcela(rs.getDouble("valorProximaParcela"));
			}
